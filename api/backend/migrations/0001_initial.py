# Generated by Django 4.2 on 2023-11-30 18:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layout', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='layout_id', to='backend.layout')),
                ('listing_type', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listing_type_id', to='backend.listingtype')),
                ('location', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='location_id', to='backend.location')),
                ('ownership', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ownership_id', to='backend.ownershipretirement')),
            ],
        ),
        migrations.CreateModel(
            name='Station',
